...
if (!empty($password) || !empty($confirmPassword)) {
    if ($password !== $confirmPassword) {
        ...
        header("Location: " . BASE_URL . "pages/MusicianSession/MusicianFeatures/Profile/Edit/editMusician.php");
        exit;
    }
}
...
if (Musicians::editMusicianByMusician($musicianInfo)) {
...
header("Location: " . BASE_URL . "pages/MusicianSession/MusicianFeatures/Profile/profile.php");
exit;
