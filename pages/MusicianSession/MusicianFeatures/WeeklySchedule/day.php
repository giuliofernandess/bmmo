...
<body>
    <a href="musicianWeeklySchedule.php">Voltar</a>

  <div>
      <div>
        <h1><?php echo htmlspecialchars($dayTitle); ?></h1>
          <div>
            <textarea name="dayProgramation" rows="10" disabled><?php echo htmlspecialchars($dayProgramation); ?></textarea>
          </div>
      </div>
  </div>
