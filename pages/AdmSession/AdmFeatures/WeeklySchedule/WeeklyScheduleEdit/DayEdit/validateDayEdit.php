...
if (!in_array($day, $allowedDays)) {
    echo "<script>alert('Dia inválido.'); window.location.href = '../../bandGroups.php';</script>";
    exit;
}
...
if ($connect->connect_error) {
    ...
    echo "<script>alert('Erro ao conectar com o banco de dados.'); window.location.href = '../../bandGroups.php';</script>";
    exit;
}
...
if (!$stmt) {
    ...
    echo "<script>alert('Erro interno no servidor.'); window.location.href = '../../bandGroups.php';</script>";
    exit;
}
...
if ($stmt->execute()) {
    ...
    echo "<script>alert('Erro ao editar o dia.'); window.location.href = '../../bandGroups.php';</script>";
}
